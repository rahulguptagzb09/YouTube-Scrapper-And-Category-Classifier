...
SVM = svm.SVC(C=2.0, kernel='linear', degree=5, probability=True)
...
print("Precision: %f "%precision_score(Test_Y, predictions_SVM, average='micro'))
print("Recall: %f "%recall_score(Test_Y, predictions_SVM, average='micro'))
print("F1: %f"% f1_score(Test_Y, predictions_SVM, average='micro'))
